...
<body>
    ...
    <main>
        ...
        <?php
            ...
            // La variable heredoc almacena una cadena de varias lineas, se utiliza para almacenar las consultas SQL
            $heredoc = <<<EOD
            Ejemplo de una consulta MySQL:
            Select nombre, apellido from empleado where edad>20;
            EOD;
            
            // Se muestra la variable de heredoc por pantalla con la funcion echo()
