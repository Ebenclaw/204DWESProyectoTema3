...
<body>
    ...
    <main>
        ...
        <?php
             ...
             * @since 06/11/2023
             */
            // PREGUNTAR COMO RECORRER UNA ARRAY ASOCIATIVO CON UN FOR() = S
            ...
            // FOR()
            // CREAR ARRAY AL QUE ASOCIAS LOS DIAS DE LAS SEMANAS A NUMEROS
            echo($aSueldos[1]);
            for ($i = 0; $i < count($aSueldos); ++$i) {
                echo($aSueldos[$i]);
            }
            
            // Con DO{}WHILE() ESTO SOBRA
            echo('<div class="ejercicio">');
            echo('<h3>DoWhile():</h3>');
            do{
