...
<body>
    ...
    <main>
        <h2>Mostrar la dirección IP del equipo desde el que estás accediendo</h2>
        <?php
            /*
            ...
            // La variable $ip almacena la ip del equipo en el que se ejecuta el programa con la variable supergolbal $_SERVER
            $ip = $_SERVER["REMOTE_ADDR"];
            
            // Se muestra la variable $ip
            echo('<div class="ejercicio">');
            echo('IP del equipo: <b>'.$ip.'</b>');
            echo('</div>');
        ?>
    </main>
    <footer>
